    ...
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap processArguments) {
        ...
        try {
            ...
            if ("JCR_PATH".equals(workflowData.getPayloadType())) {
                ...
                if (node != null) {
//                    processArgs = processArguments.get("PROCESS_ARGS", "string").toString().split(",");
//                    log.info("processArgs" + Arrays.toString(processArgs));
                    processArgs = processArguments.get("PROCESS_ARGS", "").split(":");
                    log.info("processArgs "+Arrays.toString(processArgs));
